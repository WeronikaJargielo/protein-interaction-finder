...
//
//            System.out.println("\nAmino-Aromatic interactions found:\nPosition Residue Chain Position Residue Chain Dist PolarAngle AzimuthalAngle");
//            for (Object interaction : searcher.findAminoAromaticInteractions()) { System.out.println(interaction); }

            System.out.println("\nMain Chain-Main Chain Hydrogen bonds found:\nDonor Acceptor\nPosition Residue Chain D H Position Residue Chain A Aa DistDA DistHA PhiDHA PhiHAAa PhiDAAa");
